...
import '/components/del_update_venue_btmsheet/del_update_venue_btmsheet_widget.dart';
import '/components/edit_address_bottomsheet/edit_address_bottomsheet_widget.dart';
import '/components/edit_tour_date_bottomsheet/edit_tour_date_bottomsheet_widget.dart';
import '/components/update_pickup_time_btmsheet_copy/update_pickup_time_btmsheet_copy_widget.dart';
...
class _TourDetailsWidgetState extends State<TourDetailsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TourDetailsModel());
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(10.0, 12.0, 0.0, 12.0),
                                                                              child: Column(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        if (functions.isSelectedVenuesListEmpty(
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Add at least one venue to your itinery'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                          ...
                                          if (functions.isTourCorrectToSubmit(
                                              containerTourReffToursRecord
                                                  .tourDate,
                                              containerTourReffToursRecord
                                                  .passengers,
