...
class AddDropBottomseetWidget extends StatefulWidget {
  const AddDropBottomseetWidget({
    Key? key,
  ...
  @override
  _AddDropBottomseetWidgetState createState() =>
      _AddDropBottomseetWidgetState();
}

class _AddDropBottomseetWidgetState extends State<AddDropBottomseetWidget> {
  late AddDropBottomseetModel _model;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        maxLines: 3,
                                        validator: _model
                                            .tastingNotesFieldControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ],
