...
class _$TourMessagesRecord extends TourMessagesRecord {
  ...
  factory _$TourMessagesRecord(
      ...
      (new TourMessagesRecordBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc(0, dateSent.hashCode), senderUserReff.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('TourMessagesRecord')
