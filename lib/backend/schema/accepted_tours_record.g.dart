...
class _$AcceptedToursRecord extends AcceptedToursRecord {
  ...
  factory _$AcceptedToursRecord(
      ...
      (new AcceptedToursRecordBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc(0, tourID.hashCode), customerReff.hashCode),
                driverReff.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AcceptedToursRecord')
          ..add('tourID', tourID)
